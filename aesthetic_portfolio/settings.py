...
ROOT_URLCONF = 'aesthetic_portfolio.urls'
...
WSGI_APPLICATION = 'aesthetic_portfolio.wsgi.application'
...
# On n'écrase SQLite QUE si la variable Render est détectée
...
EMAIL_HOST_USER = "doukiyanis@gmail.com"  # 👈 Laisse le mot "resend" tel quel, c'est l'identifiant imposé
